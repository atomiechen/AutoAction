...
public class Position {
    ...
    public Position(String id, String name, double latitude, double longitude, List<String> wifiIds) {
        this.id = id;
        this.name = name;
    ...
    public Position(String id, String name, double latitude, double longitude) {
        this.id = id;
        this.name = name;
        this.latitude = latitude;
        this.longitude = longitude;
    ...
    public Position(String id, String name, List<String> wifiIds) {
        this.id = id;
        this.name = name;
        this.latitude = -200;
        this.longitude = -200;
