...
public class Position {
    ...
    public static List<Position> tsinghua_positions = new ArrayList<>(Arrays.asList(
        ...
        new Position("紫荆操场", 40.01041973704246, 116.32905743513047),
        new Position("紫荆操场", 40.009519048872775, 116.32912688020764),
        new Position("紫荆操场", 40.00954032510833, 116.32991392441578),
        new Position("紫荆操场", 40.01034527114842, 116.32983984966677),
        ...
        new Position("法律图书馆", 39.99928415168381, 116.32868161252847),
        new Position("南区宿舍", 40.0057183159939, 116.32993965332606),
        new Position("C楼自习室", 40.00975449550004, 116.32819159830733)
    ));
